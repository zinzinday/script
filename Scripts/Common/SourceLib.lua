...
-- Update script
if autoUpdate then
    SourceUpdater("SourceLib", version, "raw.github.com", "/DevnBoL/Scripts/master/Common/SourceLib.lua", LIB_PATH .. "SourceLib.lua", "/DevnBoL/Scripts/master/Common/SourceLib.version"):SetSilent(silentUpdate):CheckUpdate()
end
